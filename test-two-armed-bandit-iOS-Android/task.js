...
const choice = {
  timeline:[{
    type: jsPsychHtmlButtonResponse,
    stimulus: "<p style='position: absolute; top: 10%;left: 10%'><img src='test-two-armed-bandit-iOS-Android/stimuli/slot.png' width='80%'/></p>",
    choices: ['左','右']
  },{
    type: jsPsychHtmlButtonResponse,
    stimulus: '',
    choices: function(){
      ...
      if (last_select==0 && fb==1){
        return ["<p style='position: absolute; top: 10%;left: 15%'><img src='test-two-armed-bandit-iOS-Android/stimuli/gain.gif' width='60%'/></p>"]
      } else if (last_select==0 && fb==0){
        return ["<p style='position: absolute; top: 10%;left: 15%'><img src='test-two-armed-bandit-iOS-Android/stimuli/loss.gif' width='60%'/></p>"]
